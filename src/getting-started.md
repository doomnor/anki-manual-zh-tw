...
透過把欄位名稱寫在雙大括號內，我們告訴 Anki 用欄位內的實際資訊來取代這個部分。任何沒有寫在大括號裡的內容則保留原樣。(例如，我們不用每次加入材料時都輸入「第n頁」到頁碼欄位中——「第」和「頁」會被自動加入至每一張卡片中。) &lt;br&gt; 是一串特殊代碼，用來告訴 Anki 切換至下一行；請前往[模板 (Templates)](templates/intro.md) 部分瞭解更多資訊。
...
對於較為複雜的學科，效率最高的學習方法是建立自己的牌組。語言、科學等學科並沒有辦法只靠死記硬背來理解，你需要有解釋、背景才能有效地學習。而且，當你自己輸入資訊時，你會需要在頭腦裡釐清其中的重點，使你達成更深的理解。

如果你是語言學習者，你可能會想要下載一堆單字和它們的翻譯，但這樣的學習方法就好比學天體物理學時背誦方程式一樣。要恰當地學習，你需要教材、老師或在現實生活中對話。

    不要學習你不理解的內容。Do not learn if you do not understand.
    --SuperMemo
